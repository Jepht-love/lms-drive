# Graph Report - lms-drive  (2026-07-28)

## Corpus Check
- 750 files · ~1,733,138 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 8722 nodes · 16352 edges · 577 communities (541 shown, 36 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS · INFERRED: 64 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `b6943c06`
...
1. `createClient()` - 122 edges
2. `formatPrice()` - 67 edges
3. `files` - 62 edges
4. `_()` - 55 edges
5. `_()` - 55 edges
6. `formatDate()` - 41 edges
7. `createAdminClient()` - 37 edges
...
- `IaArrivalInspectionPage()` --calls--> `calculateRentalDays()`  [INFERRED]
  app/(dashboard)/inspections/ia-arrival/[contractId]/page.tsx → lib/utils/index.ts
...
## Communities (577 total, 36 thin omitted)

### Community 0 - "Marketing & Campagnes clients"
Cohesion: 0.03
Nodes (90): averageRgb01(), buildAnnotationsForCapture(), buildInsertPlaceholderSnapshotFromDom(), buildPickedAnchorSnapshot(), buildPinElement(), buildSvelteExpressionTextMap(), buildSveltePropValuesFromLiveElement(), captureChromeNodes() (+82 more)
...
Cohesion: 0.04
Nodes (71): AccountingPdf(), AccountingPdfData, fmt(), s, updateAgencySettings(), archiveInfractionDocument(), cancelInvoice(), generateInvoiceDraft() (+63 more)
...
Cohesion: 0.05
Nodes (49): deleteVehicle(), expenseCategoryForDamage(), loadFlags(), NewIssue, reportVehicleIssues(), resolveVehicleIssue(), setVehicleRepairStatus(), AnimatedList() (+41 more)

### Community 16 - "Maintenance & immobilisés"
Cohesion: 0.05
Nodes (35): deleteClient(), deleteContract(), deleteReservation(), resetInspection(), updateDepositDeducted(), updateDepositInfo(), updateDepositStatus(), cancelReservationOnPaymentTimeout() (+27 more)
...
Cohesion: 0.04
Nodes (54): createDueDate(), createReceivable(), createRecurringDueDates(), deleteDueDate(), markDuePaid(), restoreDueDate(), ClientCompletenessInput, getMissingClientFields() (+46 more)
...
Cohesion: 0.04
Nodes (85): AccountingTransactions(), matchesQuery(), normalize(), Tx, vehicleName(), VehicleRef, aggregate(), buildAnalysisData() (+77 more)
...
Cohesion: 0.04
Nodes (45): NotificationsPage(), businessNow(), syncAlertsToCalendar(), STATUS_MAP, GET(), ALERT_GROUPS, AlertGroup, DashboardPage() (+37 more)
...
Cohesion: 0.02
Nodes (78): applyCommercialPerks(), applyDiscount(), buildBasePayload(), CLIENT_PHOTO_SLOTS, collectPhotoPaths(), createClientAction(), createClientQuick(), parseDiscount() (+70 more)

### Community 32 - "Primitives UI (badge/button/input)"
Cohesion: 0.22
Nodes (8): stageClientDocuments(), ClientLite, ImportTriageClient(), isImage(), StagedDoc, UploadedFile, uploadFileToSupabase(), compressImageFile()

### Community 33 - "Login & éditeur KPI"
Cohesion: 0.13
Nodes (17): DOCUMENT_CATEGORIES, SENSITIVE_SUBCATEGORIES, ALL_DOC_KEYS, MemberTabsEditor(), Props, Sidebar(), ALL_TAB_KEYS, APP_TABS (+9 more)
...
Cohesion: 0.11
Nodes (21): PhotoLightbox(), PhotoLightboxProps, compressImageToBase64(), VIEW_BOXES, EDL_ZONES, Zone2D, zoneBox(), DAMAGE_TYPE_PRICES (+13 more)
...
Cohesion: 0.06
Nodes (36): AccountingLayout(), TASK_STATUS_LABELS, updateTaskStatus(), logAudit(), isManagerRole(), requireManagerPage(), GET(), confirmPage() (+28 more)
...
Cohesion: 0.05
Nodes (65): buildPriceBreakdownRecord(), createReservation(), DIACRITICS_RE, isContactBlacklisted(), isNameBlacklisted(), markReservationDeparted(), markReservationNoShow(), normalizeEmail() (+57 more)
...
Cohesion: 0.03
Nodes (55): addAccidentToVehicle(), closeInfraction(), createAccident(), createInfraction(), deleteAccident(), deleteInfraction(), lookupDriver(), markInfractionPaid() (+47 more)
...
Cohesion: 0.17
Nodes (17): fmtAgence(), conventionClauses(), ConventionData, ConventionPDF(), fmtDate(), fmtPrice(), s, decoupe() (+9 more)
...
Cohesion: 0.08
Nodes (24): createMaintenanceRecord(), deleteMaintenanceRecord(), expenseCategoryFor(), GARAGE_TYPES, markMaintenancePaid(), IMMOBILISES_STATUSES, ImmobilisesPage(), OpenAccident (+16 more)
...
Cohesion: 0.15
Nodes (14): assignClientDocuments(), bulkCreateClientDocuments(), deleteClientDocument(), deleteDocument(), replaceDocument(), sendDocumentByEmail(), uploadDocument(), DOCUMENT_SUBCATEGORIES (+6 more)
...
Cohesion: 0.14
Nodes (21): assignTrip(), cancelTrip(), deleteTrip(), endTrip(), getRole(), isManagerRole(), planTrip(), startPlannedTrip() (+13 more)
...
Cohesion: 0.07
Nodes (31): completeOnboarding(), logout(), updateSavStatus(), VALID, managerItems, navItems, SidebarProps, ROLE_LABELS (+23 more)
...
Cohesion: 0.10
Nodes (18): Props, DamageComparisonProps, DamageDrawerProps, SEVERITY_ACTIVE, SEVERITY_STYLES, DamageEntry, DamageZone, VehicleInspectionMapProps (+10 more)
...
Cohesion: 0.08
Nodes (44): applyGlobalBarLabelState(), armPageChatForTyping(), attachSteerFocusDebug(), clearSteerAwaitTimer(), collapsePageChat(), configureVoiceContext(), expandPageChat(), finishVoiceSession() (+36 more)
...
Cohesion: 0.11
Nodes (11): NO_PADDING_ROUTES, PageHeaderProps, SavContext, SavContextValue, SavProvider(), useSavContext(), MODULE_MAP, moduleFromPath() (+3 more)
...
Cohesion: 0.13
Nodes (17): calculateExtraKm(), calculateLateFee(), CLEANLINESS_LEVELS, ComputedFees, InspectionFlow(), Props, Step, ContratInfo (+9 more)
...
## Knowledge Gaps
- **2317 isolated node(s):** `Vehicle`, `Client`, `Props`, `STATUS_CONFIG`, `SupabaseClient` (+2312 more)
...
- **Why does `collectRepeatedContainerTextFindings()` connect `Community 199` to `Community 350`, `Info caution réservation`, `Community 270`?**
...
- **What connects `Vehicle`, `Client`, `Props` to the rest of the system?**
...
- **Should `Marketing & Campagnes clients` be split into smaller, more focused modules?**
  _Cohesion score 0.029118404118404117 - nodes in this community are weakly interconnected._
