# Graph Report - lms-drive  (2026-07-30)

## Corpus Check
- 756 files · ~1,755,825 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 8849 nodes · 16657 edges · 581 communities (547 shown, 34 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS · INFERRED: 67 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `62fc0047`
...
1. `createClient()` - 125 edges
2. `formatPrice()` - 68 edges
3. `_()` - 55 edges
4. `_()` - 55 edges
5. `formatDate()` - 49 edges
6. `createAdminClient()` - 43 edges
7. `files` - 38 edges
...
- `CalendarToolbarProps` --references--> `CalendarView`  [EXTRACTED]
  components/calendar/CalendarToolbar.tsx → types/calendar.ts
...
## Communities (581 total, 34 thin omitted)
...
Cohesion: 0.04
Nodes (71): updateAgencySettings(), sendDocumentByEmail(), cancelInvoice(), generateInvoiceDraft(), markRestitutionInvoiceSent(), nextInvoiceNumber(), renderContractInvoiceAttachment(), sendInvoice() (+63 more)
...
Cohesion: 0.03
Nodes (104): createReceivable(), buildPriceBreakdownRecord(), cancelReservationOnPaymentTimeout(), createReservation(), DIACRITICS_RE, isContactBlacklisted(), isNameBlacklisted(), markReservationDeparted() (+96 more)
...
Cohesion: 0.12
Nodes (15): completeOnboarding(), logout(), managerItems, navItems, Sidebar(), SidebarProps, ROLE_LABELS, roleLabel() (+7 more)
...
Cohesion: 0.03
Nodes (93): deleteVehicle(), createMaintenanceRecord(), deleteMaintenanceRecord(), expenseCategoryFor(), GARAGE_TYPES, markMaintenancePaid(), expenseCategoryForDamage(), loadFlags() (+85 more)

### Community 16 - "Maintenance & immobilisés"
Cohesion: 0.03
Nodes (77): archiveInfractionDocument(), updateTaskStatus(), NotificationsPage(), logAudit(), libelleCreneau(), businessNow(), enrichEvents(), syncAlertsToCalendar() (+69 more)
...
Cohesion: 0.08
Nodes (25): parse(), Badge(), BadgeProps, badgeVariants, DatePickerField(), parseYmd(), Props, WEEKDAYS (+17 more)
...
Cohesion: 0.09
Nodes (16): isExpiringSoon(), ActiveTab, Client, CLIENT_DOC_SHORT, DocStatus, Document, ExpiryBadge(), fmtDate() (+8 more)
...
Cohesion: 0.04
Nodes (66): AccountingPdf(), AccountingPdfData, fmt(), s, aggregate(), buildAnalysisData(), dateLabel(), pctDelta() (+58 more)
...
Cohesion: 0.21
Nodes (10): rangeFor(), getMonthDates(), isSameDay(), DAY_HEADERS, MiniCalendar(), MiniCalendarProps, DAY_HEADERS, MonthView() (+2 more)

### Community 31 - "Santé maintenance véhicule"
Cohesion: 0.03
Nodes (54): applyCommercialPerks(), applyDiscount(), buildBasePayload(), CLIENT_PHOTO_SLOTS, collectPhotoPaths(), createClientAction(), createClientQuick(), parseDiscount() (+46 more)

### Community 32 - "Primitives UI (badge/button/input)"
Cohesion: 0.17
Nodes (20): assignTriageDocuments(), deleteDocument(), moveTriageDocuments(), replaceDocument(), stageTriageDocuments(), uploadDocument(), DOCUMENT_SUBCATEGORIES, DocumentCategory (+12 more)
...
Cohesion: 0.10
Nodes (22): PhotoLightbox(), PhotoLightboxProps, compressImageToBase64(), EDL_ZONES, Zone2D, zoneBox(), DAMAGE_TYPES, DamageSeverity (+14 more)
...
Cohesion: 0.22
Nodes (11): CalendarGrid(), CalendarToolbar(), CalendarToolbarProps, rangeLabel(), DAY_ABBR, detectOverlaps(), formatDateHeader(), getColumnWindow() (+3 more)
...
Cohesion: 0.07
Nodes (19): bookOperationTransaction(), createAgency(), createOperation(), deleteAgency(), deleteOperation(), num(), parseExternalVehicle(), recordReturn() (+11 more)

### Community 47 - "Frais EDL & flow inspection"
Cohesion: 0.26
Nodes (11): LegalArticlesParams, conventionClauses(), ConventionData, ConventionPDF(), fmtDate(), fmtPrice(), s, decoupe() (+3 more)
...
Cohesion: 0.03
Nodes (59): deleteClient(), addAccidentToVehicle(), closeInfraction(), createAccident(), createInfraction(), deleteAccident(), deleteInfraction(), lookupDriver() (+51 more)
...
Cohesion: 0.20
Nodes (6): ReservationDoc, isPendingDoc(), TriageFamily, ClientLite, StagedDoc, TargetLite
...
Cohesion: 0.06
Nodes (54): assignTrip(), cancelTrip(), CONFLIT_MESSAGES, deleteTrip(), endTrip(), getRole(), isManagerRole(), planTrip() (+46 more)
...
Cohesion: 0.18
Nodes (15): getFeesTable(), getLegalArticles(), fmtDate(), fmtPrix(), PhotoJointe, RecapEdl, RecapRetour, RecapSignatures() (+7 more)
...
Cohesion: 0.05
Nodes (45): AccountingTransactions(), matchesQuery(), normalize(), Tx, vehicleName(), VehicleRef, paymentMethodLabel(), AccountingLayout() (+37 more)
...
Cohesion: 0.21
Nodes (10): bulkCreateClientDocuments(), deleteClientDocument(), ClientDoc, ClientDocuments(), isImage(), Side, Staged, UploadedFile (+2 more)
...
Cohesion: 0.13
Nodes (18): EVENT_COLORS, EVENT_STATUS_LABELS, EVENT_TYPE_LABELS, STATUS_COLORS, CreateMenuProps, OPTIONS, ASSIGNABLE, ClientOption (+10 more)
...
Cohesion: 0.11
Nodes (16): Props, DamageComparisonProps, VIEW_BOXES, DamageEntry, VEHICLE_ZONES, VehicleView, VIEW_LABELS, Props (+8 more)
...
Cohesion: 0.04
Nodes (34): closeCampaign(), createCampaign(), deleteCampaign(), updateCampaignStatus(), ClientFormProps, DossierBadge(), AnimatedList(), AnimatedListItem() (+26 more)
...
## Knowledge Gaps
- **2377 isolated node(s):** `Step`, `ComputedFees`, `CLEANLINESS_LEVELS`, `ZONES_VITRAGE`, `ZONES_JANTE` (+2372 more)
...
- **What connects `Step`, `ComputedFees`, `CLEANLINESS_LEVELS` to the rest of the system?**
