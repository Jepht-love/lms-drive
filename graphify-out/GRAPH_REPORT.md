# Graph Report - lms-drive  (2026-06-30)

## Corpus Check
- 345 files · ~558,279 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1347 nodes · 2561 edges · 101 communities (85 shown, 16 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 26 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `92c245cb`
...
4. `createAdminClient()` - 22 edges
5. `CalendarEvent` - 21 edges
...
Cohesion: 0.12
Nodes (14): closeInfraction(), createAccident(), createInfraction(), lookupDriver(), markInfractionPaid(), num(), transmitInfractionToClient(), Driver (+6 more)
...
Cohesion: 0.05
Nodes (37): conventionClauses(), ConventionPreviewClient(), formatDateTime(), formatPrice(), Props, ConventionPage(), managerItems, navItems (+29 more)

### Community 6 - "Community 6"
Cohesion: 0.17
Nodes (9): InfractionDetailPage(), SinistreDetailPage(), Vehicle, INFRACTION_STATUS, infractionTypeLabel(), SINISTRE_STATUS, ProfilePage(), formatDate() (+1 more)
...
Cohesion: 0.16
Nodes (8): calculateExtraKm(), calculateLateFee(), CLEANLINESS_LEVELS, ComputedFees, Props, Step, buildDamageFlag(), SignatureCanvasProps
...
Cohesion: 0.06
Nodes (53): AlertPanelProps, CalendarBottomBarProps, CalendarGrid(), CalendarGridProps, CalendarPage(), mobilePeriodLabel(), rangeFor(), SlotContext (+45 more)

### Community 16 - "Community 16"
Cohesion: 0.21
Nodes (9): createReservation(), DIACRITICS_RE, isNameBlacklisted(), normalizeName(), postRentalRevenue(), validateContract(), logAudit(), DepartureInspectionPage() (+1 more)
...
Cohesion: 0.06
Nodes (42): AccountingPdf(), AccountingPdfData, fmt(), s, updateAgencySettings(), generateInvoiceDraft(), nextInvoiceNumber(), sendInvoice() (+34 more)

### Community 23 - "Community 23"
Cohesion: 0.06
Nodes (24): closeCampaign(), createCampaign(), updateCampaignStatus(), AnimatedList(), AnimatedListItem(), AnimatedTabsProps, Tab, Props (+16 more)
...
Cohesion: 0.12
Nodes (7): Toast, ToastContext, ToastProvider(), ToastType, DashboardLayout(), TABS, PageHeaderProps
...
Cohesion: 0.21
Nodes (9): DamageComparisonProps, VIEW_BOXES, DAMAGE_TYPE_PRICES, DAMAGE_TYPES, defaultDamagePrice(), GRAVITES, VEHICLE_ZONES, VehicleView (+1 more)
...
Cohesion: 0.33
Nodes (4): getCategoryLabel(), periodRange(), AccountingPage(), PERIODS
...
Cohesion: 0.20
Nodes (6): FuelGaugeProps, DEPARTURE_DEMO, RETURN_DEMO, DamageEntry, VehicleInspectionMapProps, Props
...
- **Why does `createClient()` connect `Community 14` to `Community 1`, `Community 2`, `Community 5`, `Community 6`, `Community 7`, `Community 8`, `Community 9`, `Community 10`, `Community 11`, `Community 16`, `Community 18`, `Community 22`, `Community 23`, `Community 25`, `Community 29`, `Community 30`, `Community 31`, `Community 33`, `Community 34`, `Community 39`, `Community 40`, `Community 43`, `Community 45`, `Community 46`, `Community 47`, `Community 48`, `Community 50`, `Community 53`, `Community 76`, `Community 81`, `Community 84`, `Community 85`, `Community 88`, `Community 89`, `Community 90`, `Community 91`, `Community 93`, `Community 95`, `Community 97`, `Community 104`?**
  _High betweenness centrality (0.159) - this node is a cross-community bridge._
- **Why does `createClient()` connect `Community 54` to `Community 2`, `Community 3`, `Community 102`, `Community 13`, `Community 77`, `Community 15`, `Community 49`, `Community 83`, `Community 23`, `Community 94`, `Community 31`?**
  _High betweenness centrality (0.024) - this node is a cross-community bridge._
- **Why does `DamageEntry` connect `Community 101` to `Community 32`, `Community 44`, `Community 13`, `Community 80`, `Community 19`, `Community 20`?**
