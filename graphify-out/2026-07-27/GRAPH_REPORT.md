...
## Corpus Check
- 745 files · ~1,725,764 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 8712 nodes · 16335 edges · 583 communities (548 shown, 35 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS · INFERRED: 63 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `78e4d3d2`
...
## Communities (583 total, 35 thin omitted)
...
Cohesion: 0.06
Nodes (58): updateAgencySettings(), cancelInvoice(), generateInvoiceDraft(), markRestitutionInvoiceSent(), nextInvoiceNumber(), renderContractInvoiceAttachment(), sendInvoice(), SupabaseServer (+50 more)
...
Cohesion: 0.09
Nodes (21): AuditLog, Contract, ContractStatus, DamagedZone, DepositStatus, Document, DocumentCategory, Incident (+13 more)
...
Cohesion: 0.21
Nodes (9): archiveInfractionDocument(), deleteDocument(), replaceDocument(), sendDocumentByEmail(), uploadDocument(), DOCUMENT_SUBCATEGORIES, DocumentCategory, SENSITIVE_SUBCATEGORIES (+1 more)
...
Cohesion: 0.05
Nodes (54): createMaintenanceRecord(), deleteMaintenanceRecord(), expenseCategoryFor(), GARAGE_TYPES, markMaintenancePaid(), IMMOBILISES_STATUSES, ImmobilisesPage(), OpenAccident (+46 more)

### Community 16 - "Maintenance & immobilisés"
Cohesion: 0.09
Nodes (30): AccountingTransactions(), matchesQuery(), normalize(), Tx, vehicleName(), VehicleRef, paymentMethodLabel(), assertPeriodOpen() (+22 more)
...
Cohesion: 0.15
Nodes (15): applyCommercialPerks(), applyDiscount(), buildBasePayload(), CLIENT_PHOTO_SLOTS, collectPhotoPaths(), createClientAction(), createClientQuick(), parseDiscount() (+7 more)
...
Cohesion: 0.04
Nodes (77): AccountingPdf(), AccountingPdfData, fmt(), s, aggregate(), buildAnalysisData(), dateLabel(), pctDelta() (+69 more)
...
Cohesion: 0.04
Nodes (60): NotificationsPage(), businessNow(), enrichEvents(), generateAlertsForEvent(), syncAlertsToCalendar(), STATUS_MAP, AnimatedList(), AnimatedListItem() (+52 more)
...
Cohesion: 0.08
Nodes (22): deleteAgency(), DeleteAgencyButton(), COLORS, ICONS, NotificationsList(), AssignStatusButton(), Toast, ToastContext (+14 more)

### Community 32 - "Primitives UI (badge/button/input)"
Cohesion: 0.05
Nodes (49): ClientCompletenessInput, getMissingClientFields(), isClientComplete(), parse(), Client, Props, Vehicle, Badge() (+41 more)
...
Cohesion: 0.09
Nodes (24): PhotoLightbox(), PhotoLightboxProps, compressImageToBase64(), DamageComparisonProps, VIEW_BOXES, EDL_ZONES, Zone2D, zoneBox() (+16 more)
...
Cohesion: 0.04
Nodes (45): deleteClient(), addAccidentToVehicle(), closeInfraction(), createAccident(), createInfraction(), deleteAccident(), deleteInfraction(), lookupDriver() (+37 more)
...
Cohesion: 0.04
Nodes (70): parseExternalVehicle(), startEntrantRental(), buildPriceBreakdownRecord(), cancelReservationOnPaymentTimeout(), createReservation(), DIACRITICS_RE, isContactBlacklisted(), isNameBlacklisted() (+62 more)

### Community 47 - "Frais EDL & flow inspection"
Cohesion: 0.03
Nodes (45): AccountingLayout(), deleteContract(), deleteReservation(), resetInspection(), updateDepositInfo(), updateDepositStatus(), bookOperationTransaction(), createAgency() (+37 more)
...
Cohesion: 0.05
Nodes (27): completeOnboarding(), logout(), TASK_STATUS_LABELS, updateTaskStatus(), Vehicle, STATUS_CONFIG, Props, managerItems (+19 more)
...
Cohesion: 0.13
Nodes (17): assignClientDocuments(), bulkCreateClientDocuments(), deleteClientDocument(), stageClientDocuments(), getSubcategoryLabel(), ClientDoc, ClientDocuments(), isImage() (+9 more)
...
Cohesion: 0.19
Nodes (10): Props, DamageDrawerProps, SEVERITY_ACTIVE, SEVERITY_STYLES, DamageEntry, DamageZone, VehicleInspectionMapProps, PreviousZone (+2 more)
...
Cohesion: 0.14
Nodes (15): calculateExtraKm(), calculateLateFee(), CLEANLINESS_LEVELS, ComputedFees, InspectionFlow(), Props, Step, ContratInfo (+7 more)
...
Cohesion: 0.15
Nodes (8): DossierBadge(), SwipeableRowProps, SwipeAction, DossierFields, dossierMissing(), IDENTITY_SUBS, isDossierComplet(), PERMIS_SUBS
...
Cohesion: 0.23
Nodes (10): expenseCategoryForDamage(), loadFlags(), NewIssue, reportVehicleIssues(), resolveVehicleIssue(), setVehicleRepairStatus(), VehicleNeed, MaintenanceFlag (+2 more)
...
Cohesion: 0.15
Nodes (8): ClientForm(), ClientFormProps, DISCOUNT_PRESETS, DOC_TYPES, PAYMENT_METHODS, PHOTO_SLOTS, PhotoSlot, Client
...
## Knowledge Gaps
- **2312 isolated node(s):** `ALLOWED_FIELDS`, `MONTHS`, `SupabaseServer`, `DIACRITICS_RE`, `Props` (+2307 more)
...
- **What connects `ALLOWED_FIELDS`, `MONTHS`, `SupabaseServer` to the rest of the system?**
