...
## Corpus Check
- 742 files · ~1,720,470 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 8700 nodes · 16255 edges · 575 communities (541 shown, 34 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS · INFERRED: 63 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `7ae48a1e`
...
## Communities (575 total, 34 thin omitted)
...
Cohesion: 0.04
Nodes (43): updateAgencySettings(), TASK_STATUS_LABELS, updateTaskStatus(), businessNow(), confirmPage(), GET(), AGENCY_DEFAULTS, AgencySettings (+35 more)
...
Cohesion: 0.15
Nodes (17): AccountingLayout(), DELETE(), PATCH(), logAudit(), isManagerRole(), requireManagerPage(), enrichEvents(), generateAlertsForEvent() (+9 more)
...
Cohesion: 0.04
Nodes (79): AccountingPdf(), AccountingPdfData, fmt(), s, aggregate(), buildAnalysisData(), dateLabel(), pctDelta() (+71 more)
...
Cohesion: 0.05
Nodes (29): closeCampaign(), createCampaign(), deleteCampaign(), updateCampaignStatus(), ClientFormProps, DossierBadge(), AnimatedList(), AnimatedListItem() (+21 more)
...
Cohesion: 0.10
Nodes (26): AccountingTransactions(), matchesQuery(), normalize(), Tx, vehicleName(), VehicleRef, paymentMethodLabel(), assertPeriodOpen() (+18 more)
...
Cohesion: 0.19
Nodes (10): ALERT_GROUPS, AlertGroup, DashboardPage(), getClient(), getVehicle(), isDepart(), TASK_STATUS_BADGE, TASK_STATUS_LABEL (+2 more)
...
Cohesion: 0.14
Nodes (17): rangeFor(), DAY_ABBR, detectOverlaps(), formatDateHeader(), getColumnWindow(), getEventPosition(), getMonthDates(), isSameDay() (+9 more)

### Community 31 - "Santé maintenance véhicule"
Cohesion: 0.07
Nodes (23): deleteClient(), PAYMENT_LABELS, DOCS, Props, ClientPage(), InfractionDetailPage(), STATUS_LABELS, STATUS_RES (+15 more)

### Community 32 - "Primitives UI (badge/button/input)"
Cohesion: 0.06
Nodes (37): ClientCompletenessInput, getMissingClientFields(), isClientComplete(), parse(), Client, Props, Vehicle, Badge() (+29 more)
...
Cohesion: 0.05
Nodes (30): addDays(), formatAmount(), formatDate(), GET(), localDateStr(), OVERDUE_DAYS, UPCOMING_DAYS, COLORS (+22 more)
...
Cohesion: 0.09
Nodes (23): PhotoLightbox(), PhotoLightboxProps, compressImageToBase64(), DamageComparisonProps, VIEW_BOXES, EDL_ZONES, Zone2D, zoneBox() (+15 more)
...
Cohesion: 0.19
Nodes (6): SlotContext, MobileCalendarPanelProps, ResourceListProps, ROLE_LABELS, CalendarResource, UserRole

### Community 44 - "Community 44"
Cohesion: 0.05
Nodes (33): addAccidentToVehicle(), closeInfraction(), createAccident(), createInfraction(), deleteAccident(), deleteInfraction(), lookupDriver(), markInfractionPaid() (+25 more)
...
Cohesion: 0.03
Nodes (100): deleteContract(), deleteReservation(), resetInspection(), updateDepositDeducted(), updateDepositInfo(), updateDepositStatus(), cancelReservationOnPaymentTimeout(), createReservation() (+92 more)

### Community 47 - "Frais EDL & flow inspection"
Cohesion: 0.06
Nodes (45): cancelInvoice(), generateInvoiceDraft(), markRestitutionInvoiceSent(), nextInvoiceNumber(), renderContractInvoiceAttachment(), sendInvoice(), SupabaseServer, updateInvoiceLines() (+37 more)
...
Cohesion: 0.10
Nodes (28): assignTrip(), cancelTrip(), deleteTrip(), endTrip(), getRole(), isManagerRole(), planTrip(), startPlannedTrip() (+20 more)
...
Cohesion: 0.18
Nodes (15): getFeesTable(), getLegalArticles(), LegalArticlesParams, fmtDate(), fmtPrix(), PhotoJointe, RecapEdl, RecapRetour (+7 more)
...
Cohesion: 0.17
Nodes (7): AlertPanelProps, ALERT_RULES, EventBlockProps, STATUS_ICON, AlertType, CalendarAlert, CalendarTeam
...
Cohesion: 0.06
Nodes (46): deleteVehicle(), createMaintenanceRecord(), deleteMaintenanceRecord(), expenseCategoryFor(), GARAGE_TYPES, markMaintenancePaid(), RESA_STATUS_LABEL, VehiclePage() (+38 more)
...
Cohesion: 0.21
Nodes (11): CalendarBottomBarProps, CalendarGrid(), CalendarGridProps, CalendarSidebarProps, CalendarToolbar(), CalendarToolbarProps, rangeLabel(), getWeekDates() (+3 more)
...
Cohesion: 0.12
Nodes (19): EVENT_COLORS, EVENT_STATUS_LABELS, EVENT_TYPE_LABELS, RESOURCE_PALETTE, STATUS_COLORS, CreateMenuProps, OPTIONS, Props (+11 more)
...
Cohesion: 0.10
Nodes (14): Props, DamageDrawerProps, SEVERITY_ACTIVE, SEVERITY_STYLES, DamageEntry, DamageZone, VehicleInspection3DProps, ZoneDef (+6 more)
...
## Knowledge Gaps
- **2311 isolated node(s):** `1. Ce que c'est`, `Le périmètre a évolué depuis, avec l'accord du gérant`, `3. Ce dépôt ne porte plus qu'une chose : LMS Drive`, `4. Le socle sert à équiper d'autres clients — et c'est voulu`, `5. Qui s'en sert` (+2306 more)
...
- **What connects `1. Ce que c'est`, `Le périmètre a évolué depuis, avec l'accord du gérant`, `3. Ce dépôt ne porte plus qu'une chose : LMS Drive` to the rest of the system?**
