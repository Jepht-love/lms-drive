# Graph Report - lms-drive  (2026-07-29)

## Corpus Check
- 754 files · ~1,740,160 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 8737 nodes · 16388 edges · 583 communities (546 shown, 37 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS · INFERRED: 64 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `ba16f086`
...
2. `formatPrice()` - 68 edges
3. `files` - 62 edges
4. `_()` - 55 edges
5. `_()` - 55 edges
6. `formatDate()` - 42 edges
...
- `SlotContext` --references--> `CalendarResource`  [EXTRACTED]
  components/calendar/EventDrawer.tsx → types/calendar.ts
...
## Communities (583 total, 37 thin omitted)
...
Cohesion: 0.10
Nodes (35): cancelInvoice(), generateInvoiceDraft(), markRestitutionInvoiceSent(), nextInvoiceNumber(), renderContractInvoiceAttachment(), sendInvoice(), SupabaseServer, updateInvoiceLines() (+27 more)
...
Cohesion: 0.14
Nodes (19): paymentMethodLabel(), assertPeriodOpen(), SB, closeAnnualAccounting(), closeDailyAccounting(), closeMonthlyAccounting(), createTransaction(), deleteTransaction() (+11 more)
...
Cohesion: 0.06
Nodes (48): deleteVehicle(), createMaintenanceRecord(), deleteMaintenanceRecord(), expenseCategoryFor(), GARAGE_TYPES, markMaintenancePaid(), RESA_STATUS_LABEL, VehiclePage() (+40 more)

### Community 16 - "Maintenance & immobilisés"
Cohesion: 0.04
Nodes (55): AccountingLayout(), deleteContract(), deleteReservation(), resetInspection(), updateDepositDeducted(), updateDepositInfo(), updateDepositStatus(), markReservationDeparted() (+47 more)
...
Cohesion: 0.03
Nodes (98): buildPriceBreakdownRecord(), cancelReservationOnPaymentTimeout(), createReservation(), DIACRITICS_RE, isContactBlacklisted(), isNameBlacklisted(), markReservationNoShow(), normalizeEmail() (+90 more)
...
Cohesion: 0.04
Nodes (73): AccountingPdf(), AccountingPdfData, fmt(), s, aggregate(), buildAnalysisData(), dateLabel(), pctDelta() (+65 more)
...
Cohesion: 0.04
Nodes (50): updateSavStatus(), VALID, GET(), ALERT_GROUPS, AlertGroup, DashboardPage(), getClient(), getVehicle() (+42 more)
...
Cohesion: 0.03
Nodes (75): applyCommercialPerks(), applyDiscount(), buildBasePayload(), CLIENT_PHOTO_SLOTS, collectPhotoPaths(), createClientAction(), parseDiscount(), updateClientAction() (+67 more)

### Community 32 - "Primitives UI (badge/button/input)"
Cohesion: 0.11
Nodes (22): createClientQuick(), assignClientDocuments(), bulkCreateClientDocuments(), deleteClientDocument(), deleteDocument(), replaceDocument(), sendDocumentByEmail(), stageClientDocuments() (+14 more)
...
Cohesion: 0.08
Nodes (28): PhotoLightbox(), PhotoLightboxProps, Props, DamageComparisonProps, VIEW_BOXES, DamageDrawerProps, SEVERITY_ACTIVE, SEVERITY_STYLES (+20 more)
...
Cohesion: 0.11
Nodes (20): TASK_STATUS_LABELS, updateTaskStatus(), businessNow(), AvailabilityPage(), supportContactBlock(), heureAgence(), instantDepuisSaisie(), jourHeureAgence() (+12 more)
...
Cohesion: 0.08
Nodes (17): bookOperationTransaction(), createAgency(), createOperation(), deleteOperation(), num(), parseExternalVehicle(), recordReturn(), startEntrantRental() (+9 more)
...
Cohesion: 0.04
Nodes (51): deleteClient(), archiveInfractionDocument(), addAccidentToVehicle(), closeInfraction(), createAccident(), createInfraction(), deleteAccident(), deleteInfraction() (+43 more)
...
Cohesion: 0.06
Nodes (27): AccountingTransactions(), matchesQuery(), normalize(), Tx, vehicleName(), VehicleRef, closeCampaign(), createCampaign() (+19 more)
...
Cohesion: 0.09
Nodes (36): assignTrip(), cancelTrip(), CONFLIT_MESSAGES, deleteTrip(), endTrip(), getRole(), isManagerRole(), planTrip() (+28 more)
...
Cohesion: 0.20
Nodes (12): getFeesTable(), getLegalArticles(), LegalArticlesParams, fmtDate(), fmtPrix(), PhotoJointe, RecapEdl, RecapRetour (+4 more)
...
Cohesion: 0.31
Nodes (7): Delai, libelleDelai(), TonDelai, DelaiPastille(), DelaiPastilleProps, FamilleDelai, PALETTES
...
Cohesion: 0.07
Nodes (21): completeOnboarding(), logout(), Vehicle, Props, managerItems, navItems, Sidebar(), SidebarProps (+13 more)
...
Cohesion: 0.15
Nodes (10): VEHICLE_ZONES, VehicleView, BODY_OUTLINE, LABEL, LAYOUT, Props, VIEW_VB, VIEWS (+2 more)
...
Cohesion: 0.05
Nodes (34): updateAgencySettings(), confirmPage(), GET(), AGENCY_DEFAULTS, AgencySettings, getAgencySettings(), STATUS_CONFIG, ConventionPage() (+26 more)
...
## Knowledge Gaps
- **2321 isolated node(s):** `Vehicle`, `DueDate`, `WEEK_ABBR`, `CREATE_TYPES`, `Profile` (+2316 more)
...
- **What connects `Vehicle`, `DueDate`, `WEEK_ABBR` to the rest of the system?**
