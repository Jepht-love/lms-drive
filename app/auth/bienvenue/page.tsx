 ...
 * Son profil (rôle, permissions) a été créé par le gérant à l'invitation —
 * une fois le mot de passe enregistré, il entre directement dans son espace.
 */
export default function BienvenuePage() {
  ...
  // Sans session (accès direct à l'URL, cookie expiré) → retour au login.
  useEffect(() => {
